...
// =========================================================
//
// The following assembly code is the vtable layout for the AnotherDerived
// class:
// *******************
...
// =========================================================
//
// The following assembly code is the vtable layout for the
// AnotherDerivedDerived class:
// *******************
...
public:
  ...
  virtual void MemberFunc() { cout << "hello" << endl; }
...
class AnotherDerived : public Base, public AnotherBase {
public:
  AnotherDerived() : AnotherDerivedData(4) {}
...
class AnotherDerivedDerived : public AnotherDerived {
public:
  AnotherDerivedDerived() : AnotherDerivedDerivedData(5) {}
...
int main(int argc, char *argv[]) {
  ...
  cout << "sizeof AnotherDerivedDerived: " << sizeof(AnotherDerivedDerived)
       << endl;
